...
Archivo de entrada principal para el dashboard de reservas.
Utiliza el sistema consolidado de módulos core/.

Uso: python reservas_optimizado.py
...
if __name__ == "__main__":
    print("🚤 INICIANDO DASHBOARD DE RESERVAS HOTBOAT OPTIMIZADO...")
    print("=" * 60)
    ...
    try:
        app, puerto = inicializar_dashboard('reservas')
