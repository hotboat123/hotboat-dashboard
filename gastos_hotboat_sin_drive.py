...
from inputs_modelo import diccionario_categorias, descripciones_a_eliminar, diccionario_categoria_1, tabla_correcciones, eliminaciones_fecha_monto, valor_aproximado_dolar, gastos_efectivo
